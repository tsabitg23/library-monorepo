...
export class InitSchema1788138156886 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "book_loans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "book_inventory_id" uuid NOT NULL, "user_id" uuid NOT NULL, "return_date" TIMESTAMP, "return_deadline" TIMESTAMP NOT NULL, "status" character varying NOT NULL, "checkout_condition" character varying NOT NULL, "return_condition" character varying NOT NULL, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_f7ad6d7bdab26c03e3fd6efeb55" PRIMARY KEY ("id"))`);
